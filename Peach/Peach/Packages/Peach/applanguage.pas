...
var AppLang: string;                               // The name of the "application language".
...
Keyword, Phrase: array [1..1000] of string;    // They're parallel, keyword[n] corresponds to phrase[n]
KeywordCount: integer;                             // This says how many entries there are in the arrays, obviously.
